...
ARGS = ['-O3', '-DNDEBUG', '-DKENLM_MAX_ORDER='+max_order, '-std=c++11', '-fopenmp']
...
cythonize("python/dag_search.pyx")

ext_modules = [
    Extension(name='dag_search',
        sources=FILES + ['python/dag_search.cpp', 'python/SearchBeam.cpp'],
        language='C++', 
        include_dirs=['.'],
        libraries=LIBS, 
